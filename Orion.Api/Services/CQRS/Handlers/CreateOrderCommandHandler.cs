...
public class CreateOrderCommandHandler : ICommandHandler<CreateOrderCommand, OrderResponse>
{
    ...
    private readonly EventSourcingStore _eventStore;
    ...
    private List<OrderItemDataDetailed> CreateOrderItemsDetailed(List<OrderItemRequest> items, List<Inventory> inventoryItems)
    {

...
{
    /// <inheritdoc />
    public partial class AddInventoryUsersAndOrderItems : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Seed Users table with data for existing orders
            migrationBuilder.Sql(@"
                INSERT INTO ""Users"" (""UserId"", ""Email"", ""FirstName"", ""LastName"", ""CreatedAt"", ""UpdatedAt"")
                SELECT DISTINCT 
                    CASE WHEN ""UserId"" = '' OR ""UserId"" IS NULL THEN 'default-user' ELSE ""UserId"" END,
                    CASE WHEN ""UserId"" = '' OR ""UserId"" IS NULL THEN 'default@example.com' ELSE ""UserId"" || '@example.com' END,
                    'Default',
                    'User',
                    NOW(),
                    NOW()
            ...
            // Update empty or null UserIds to 'default-user'
            migrationBuilder.Sql(@"
                UPDATE ""Orders"" 

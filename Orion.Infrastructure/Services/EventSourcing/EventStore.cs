...
namespace Orion.Infrastructure.Services.EventSourcing;
...
public class EventStore : IEventStore
{
    ...
    public EventStore(IOrionDbContext context, ILogger<EventStore> logger, IHttpContextAccessor? httpContextAccessor = null)
    {
        _context = context;
        _logger = logger;
    ...
    public async Task SaveEventsAsync(Guid aggregateId, IEnumerable<BaseEvent> events, int expectedVersion)
    {
        ...
        try
        {
            await _context.EventStore.AddRangeAsync(eventEntries);
